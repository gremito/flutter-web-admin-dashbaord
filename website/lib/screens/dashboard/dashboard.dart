  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: <Widget>[
        ...
        //                     return tickets(colors[i], context, icons[i], randomNumbers[i], newTexts[i]);
        //                   }),
        //                 )
        //               : Row(
        //                   mainAxisAlignment: MainAxisAlignment.spaceAround,
        ...
        //           ),
        //           loading
        //               ? tableCard(context, ApiData.githubTrendingModel)
        ...
        SliverGrid(
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: MediaQuery.of(context).size.width < 1300 ? 0.6 : 0.65,
            mainAxisSpacing: 10,
          ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Text(
                                "Beautiful Nature",
                                style: TextStyle( fontSize: 16, fontFamily: 'HelveticaNeue' ),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.all(8.0),
